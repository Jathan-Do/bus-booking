...
<div class="container">
    <div class="padding-divide pb-0">
        <h3 class="text-center fw-bold fs-2 text-blue-main mb-1 text-uppercase">FUTA BUS LINES - CHẤT LƯỢNG LÀ DANH DỰ</h3>
...
<div class=" bg-orange">
    <div class="container">
        <!-- CATEGORY COLLECTION -->
        <div class=" padding-divide pb-0">
            <h3 class=" text-center fw-bold fs-2 text-blue-main mb-3">KHUYẾN MÃI NỔI BẬT</h3>
            <div id="carouselPromotionIndicators" class="carousel slide pb-5" data-bs-ride="true">
                <div class="carousel-indicators">
...
<div class="container">
    <!-- CATEGORY COLLECTION -->
    <div class=" padding-divide pb-0">
        <h3 class="text-center  fw-bold fs-2 text-blue-main mb-1">TUYẾN PHỔ BIẾN</h3>
        <p class="text-center font-italic text-muted mb-4">Được khánh hàng tin tưởng và lựa chọn</p>
        <div class="row">
            <!-- CATEGORY Item-->
...
<div class=" bg-orange">
    <div class="container">
        <div class="padding-divide">
            <h3 class="text-center fw-bold fs-2 text-blue-main mb-1 text-uppercase">FUTA BUS LINES - CHẤT LƯỢNG LÀ DANH DỰ</h3>
            <p class="text-center font-italic text-muted mb-4">Được khánh hàng tin tưởng và lựa chọn</p>
            <div class="row ml-3 ps-5">
                <div class="col-lg-6 row gap-2 ps-3">
                    <div class="col-2">
                        <img src="<?php echo base_url('/assets/images/Group.svg') ?>" />
                    </div>
                    <div class="col-10 row">
                        <p class="row-2 fw-bold fs-2">Hơn 20 Triệu <span class="fw-bold fs-6 mx-1">Lượt khách</span></p>
                        <p class="row-4 text-secondary fw-semibold">Phương Trang phục vụ hơn 20 triệu lượt khách bình quân 1 năm trên toàn quốc</p>
                    </div>
                    <div class="col-2">
                        <img src="<?php echo base_url('/assets/images/Store.svg') ?>" />
                    </div>
                    <div class="col-10 row">
                        <p class="row-2 fw-bold fs-2">Hơn 350 <span class="fw-bold fs-6 mx-1">Phòng vé - Bưu cục</span></p>
                        <p class="row-4 text-secondary fw-semibold">Phương Trang có hơn 350 phòng vé, trạm trung chuyển, bến xe,... trên toàn hệ thống</p>
                    </div>
                    <div class="col-2">
                        <img src="<?php echo base_url('/assets/images/Group_2.svg') ?>" />
                    </div>
                    <div class="col-10 row">
                        <p class="row-2 fw-bold fs-2">
                            Hơn 1,000 <span class="fw-bold fs-6 mx-1">Chuyến xe</span></p>
                        <p class="row-4 text-secondary fw-semibold">Phương Trang phục vụ hơn 1,000 chuyến xe đường dài và liên tỉnh mỗi ngày</p>
                    </div>
                </div>
                <div class="col-lg-6 ps-5 ms-4">
                    <img class="ps-5" src="<?php echo base_url('/assets/images/image.svg') ?>" />
                </div>
            </div>
        </div>
    </div>
